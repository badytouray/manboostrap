          ...
          <div className="row">
            ...
            <div className="col-75">
              <select name="subject">
                ...
                <option value="Eyebrow touch up">Eyebrow touch up</option>
                <option value="Mens chest wax">Mens chest wax</option>
                <option value="Mens back wax">Mens back wax</option>
                <option value="Book for an event">Book for an event</option>
                <option value="Leg Wax">Leg Wax</option>
